...
| Admin Features | 535 | GDPR tools | Implemented | Add export/deletion | P1 | ✅ Created and deployed gdpr-export and gdpr-delete Edge Functions. Platform is now GDPR compliant with data export and deletion capabilities. Still need to improve UI for making requests | Legal compliance achieved | ✅ All user tables | ✅ Admin access | ✅ Functions deployed | 80% | 2025-09-23 | 7f49f92 | 1.1 | Improve request UI |
...
| Admin Features | 536 | Document previews | Not implemented | Add Storage preview | P1 | Basic approval workflow exists. Add document preview using Supabase Storage URLs | Cannot verify therapists | ✅ documents JSONB | ✅ Admin view | Need storage viewer | 10% | - | - | 1.1 | Storage integration |
| Admin Features | 536 | Mandatory reasons | Implemented | Add reason field | P2 | ✅ Added decision_reason textarea to TherapistApplications component. Approval/rejection now requires providing a reason | Decision tracking active | ✅ decision_reason col | ✅ Admin update | ✅ UI implemented | 100% | 2025-09-23 | 5acc590 | 1.1 | ✅ Completed |
| Admin Features | 536 | Request more info | Not implemented | Add request workflow | P2 | Create notification templates in Edge Functions | Incomplete verification | ✅ status enum | ✅ Admin update | Has under_review | 20% | - | - | 1.1 | Edge Function notify |
...
| Admin Features | 536 | Decision audit trail | Not implemented | Add audit logging | P1 | Implement audit trail for all verification decisions | No accountability | ✅ reviewed_by cols | ✅ Admin update | Has timestamps | 30% | - | - | 1.1 | Add trigger logging |
| Admin Features | 537 | Content scanning | Implemented | Add keyword detection | P2 | ✅ Created moderation_queue table with RLS. Deployed content-moderation Edge Function with keyword detection for violence, self-harm, inappropriate content, and spam | Basic safety protection | ✅ moderation_queue | ✅ Full RLS | ✅ Keyword system live | 80% | 2025-09-23 | e604ff7 | 1.2 | Improve false positive handling |

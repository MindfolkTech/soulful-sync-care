      ...
      <main className="flex-1 py-16">
        <Container>
          <div className="max-w-4xl mx-auto prose prose-slate">
            ...
            <div className="space-y-8 font-secondary text-text-secondary">
              <section>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Personal Information</h3>
                  ...
                  <div>
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Health Data (Special Category)</h3>
                    <ul className="list-disc ml-6 space-y-1">
                  ...
                  <div>
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Technical Data</h3>
                    <ul className="list-disc ml-6 space-y-1">
              ...
              <section>
                ...
                <div className="space-y-3">
                  <div className="p-4 bg-background border rounded-lg">
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Consent (Article 6(1)(a))</h3>
                    <p>Marketing communications, optional data collection, and non-essential cookies</p>
                  </div>
                  
                  <div className="p-4 bg-background border rounded-lg">
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Contract (Article 6(1)(b))</h3>
                    <p>Service delivery, therapist matching, session booking, and payment processing</p>
                  </div>
                  
                  <div className="p-4 bg-background border rounded-lg">
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Legitimate Interest (Article 6(1)(f))</h3>
                    <p>Service improvement, fraud prevention, and platform security</p>
                  </div>
                  
                  <div className="p-4 bg-background border rounded-lg">
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Vital Interests (Article 9(2)(c))</h3>
              ...
              <section>
                ...
                <div className="space-y-3">
                  <div>
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Primary Purposes</h3>
                    <ul className="list-disc ml-6 space-y-1">
                  ...
                  <div>
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Secondary Purposes</h3>
                    <ul className="list-disc ml-6 space-y-1">
              ...
              <section>
                ...
                <div className="space-y-3">
                  <div className="p-4 bg-background border rounded-lg">
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Service Providers</h3>
                    <ul className="list-disc ml-6 space-y-1">
                  ...
                  <div className="p-4 bg-background border rounded-lg">
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Legal Requirements</h3>
                    <p>We may share data when required by law, court order, or to protect our rights and safety.</p>
                  </div>
                  
                  <div className="p-4 bg-background border rounded-lg">
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Business Transfers</h3>
              ...
              <section>
                ...
                <div className="space-y-3">
                  <div className="p-4 bg-background border rounded-lg">
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Account Data</h3>
                    <p>Retained until account deletion or 3 years of inactivity</p>
                  </div>
                  
                  <div className="p-4 bg-background border rounded-lg">
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Therapy Data</h3>
                    <p>Retained for 7 years (legal requirement for healthcare records)</p>
                  </div>
                  
                  <div className="p-4 bg-background border rounded-lg">
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Analytics Data</h3>
                    <p>Anonymized data retained for 2 years for service improvement</p>
                  </div>
                  
                  <div className="p-4 bg-background border rounded-lg">
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Marketing Data</h3>
              ...
              <section>
                ...
                <div className="space-y-3">
                  <div className="p-4 bg-background border rounded-lg">
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Right of Access (Article 15)</h3>
                    <p>Request a copy of all personal data we hold about you</p>
                  </div>
                  
                  <div className="p-4 bg-background border rounded-lg">
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Right to Rectification (Article 16)</h3>
                    <p>Correct inaccurate or incomplete personal data</p>
                  </div>
                  
                  <div className="p-4 bg-background border rounded-lg">
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Right to Erasure (Article 17)</h3>
                    <p>Request deletion of your personal data in certain circumstances</p>
                  </div>
                  
                  <div className="p-4 bg-background border rounded-lg">
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Right to Data Portability (Article 20)</h3>
                    <p>Receive your data in a structured, machine-readable format</p>
                  </div>
                  
                  <div className="p-4 bg-background border rounded-lg">
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Right to Object (Article 21)</h3>
                    <p>Object to processing based on legitimate interests or for marketing</p>
                  </div>
                  
                  <div className="p-4 bg-background border rounded-lg">
                    <h3 className="font-primary font-semibold text-text-primary mb-2">Right to Restrict Processing (Article 18)</h3>
                    <p>Limit how we process your data in certain circumstances</p>
                  </div>
                </div>
                
                <div className="mt-4 p-4 bg-garden-green/10 border border-garden-green rounded-lg">
                  <p className="font-secondary text-text-primary">
              ...
              <div className="pt-6 border-t text-sm text-text-secondary">

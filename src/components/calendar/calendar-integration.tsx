      ...
      <CardContent className="p-[--space-sm] md:p-[--space-md] pt-0">
        <div className="space-y-[--space-sm]">
          ...
          <div className="flex items-center justify-between p-[--space-sm] border rounded-lg min-h-[--touch-target-min]">
            <div className="flex items-center gap-[--space-sm]">
              <div className="w-8 h-8 bg-[--surface-accent] rounded-full flex items-center justify-center">
                <Calendar className="w-4 h-4 text-[--jovial-jade]" />
              </div>
              <div>
            ...
            <div className="flex items-center gap-[--space-xs]">
              {connectedCalendars.google ? (
                <>
                  <Badge className="bg-[--success-bg] text-[--success-text] text-xs">
          ...
          {(connectedCalendars.google || connectedCalendars.outlook) && (
            <div className="flex items-center gap-[--space-xs] p-[--space-xs] bg-[--surface-accent] rounded-lg">
              <Clock className="w-4 h-4 text-[--jovial-jade]" />
              <p className="font-secondary text-[--text-secondary] text-xs">
          ...
          {/* Help Text */}
          <div className="flex items-start gap-[--space-xs] p-[--space-xs] bg-[--surface-accent] rounded-lg">
            <AlertCircle className="w-4 h-4 text-[--jovial-jade] mt-0.5 flex-shrink-0" />
            <div>
              <p className="font-secondary text-[--text-secondary] text-xs">
